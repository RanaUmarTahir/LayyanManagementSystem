    ...
    const testingFun = async () => {
        ...
        if (userData != null) {
            ...
            getAllOfCollection('Teacher').then((result) => {
                let findTeacher = result?.find(res => res?.email == data?.email && res?.passWord == data?.password)
                setTeacherData(findTeacher)
    ...
    return (
        <View>
            <View style={styles.topView}>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate('ReasuTeacherprofilel', { data: teacherData })}>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: height(10) }}>
                <View style={styles.background}>
                    ...
                    <TouchableOpacity
                        onPress={() => props.navigation.navigate('Classes', { type: 'AddResult', teacherData: teacherData })}
                        style={styles.mainView}>
